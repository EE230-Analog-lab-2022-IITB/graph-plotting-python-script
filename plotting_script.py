...
filename     = "piecewise_linear_3_resistors"              #filename : This is name of the file containing the x and y values
...
if __name__ == '__main__':
    ...
    x_readings = read_file(1)
    y_readings = []
    for column in range(2, number_of_curves_in_plot + 2):
